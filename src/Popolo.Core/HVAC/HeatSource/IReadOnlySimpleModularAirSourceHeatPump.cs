/* IReadOnlySimpleModularAirSourceHeatPump.cs
...
namespace Popolo.Core.HVAC.HeatSource
{
  ...
  public interface IReadOnlySimpleModularAirSourceHeatPump
  {
    /// <summary>Gets the current operating mode.</summary>
    SimpleModularAirSourceHeatPump.OperatingMode Mode { get; }
