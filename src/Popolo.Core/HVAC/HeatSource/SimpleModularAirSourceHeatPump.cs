/* SimpleModularAirSourceHeatPump.cs
 * 
...
namespace Popolo.Core.HVAC.HeatSource
{
  ...
  public class SimpleModularAirSourceHeatPump: IReadOnlySimpleModularAirSourceHeatPump
  {
    ...
    public SimpleModularAirSourceHeatPump(
