/* SimpleModularAirSourceHeatPumpSystem.cs
 * 
...
namespace Popolo.Core.HVAC.SystemModel
{
  ...
  public class SimpleModularAirSourceHeatPumpSystem : IHeatSourceSubSystem
  {
    ...
    private SimpleModularAirSourceHeatPump mChiller;
    ...
    public IReadOnlySimpleModularAirSourceHeatPump SimpleModularAirSourceHeatPump { get { return mChiller; } }
    ...
    private void ForecastHeating_Internal(double hotWaterFlowRate)
    {
      ...
      mChiller.Mode = HeatSource.SimpleModularAirSourceHeatPump.OperatingMode.Heating;
    ...
    private void ForecastCooling_Internal(double chilledWaterFlowRate)
    {
      ...
      mChiller.Mode = HeatSource.SimpleModularAirSourceHeatPump.OperatingMode.Cooling;
    ...
    public SimpleModularAirSourceHeatPumpSystem
