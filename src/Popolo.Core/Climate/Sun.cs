        ...
        out double globalEfficacy, out double diffuseEfficacy, out double directEfficacy)
    {
      double[][][] cf = {
                new double[][] {
                    ...
                    new double[]{ -2.716,  4.023,  0.657},
                    new double[]{-60.423, 99.559, 45.919}
                },
                new double[][] {
                    new double[]{ 4.147, 21.852,-28.685},
                    new double[]{35.775,-42.243, 25.986},
                    new double[]{-4.624, -2.305, -6.571},
                    new double[]{-11.192,-2.811, 26.243},
                    new double[]{-3.500,  4.153,  1.125},
